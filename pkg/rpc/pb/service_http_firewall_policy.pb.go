...
type UpdateHTTPFirewallPolicyRequest struct {
	...
	SilOptionsJSON   []byte   `protobuf:"bytes,11,opt,name=silOptionsJSON,proto3" json:"silOptionsJSON,omitempty"`
...
func (x *UpdateHTTPFirewallPolicyRequest) GetSilOptionsJSON() []byte {
	if x != nil {
		return x.SilOptionsJSON
	}
	return nil
}
